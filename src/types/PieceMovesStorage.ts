...
class PieceMovesStorage {
    // Pawn
    public static readonly pawnMovedVector: MovePattern = {vectors: [{x: 0, y: 1}], count: 1}
    public static readonly pawnNotMovedVector: MovePattern = {vectors: [{x: 0, y: 1}], count: 2}
    public static readonly pawnTakeVector: MovePattern = {vectors: [{x: -1, y: 1}, {x: 1, y: 1}], count: 1}
    
    // Knight
    public static readonly knightVector: MovePattern = {vectors: [{x: -1, y: -2}, {x: 1, y: -2}, {x: 2, y: -1}, {x: 2, y: 1}, {x: 1, y: 2}, {x: -1, y: 2}, {x: -2, y: 1}, {x: -2, y: -1}], count: 1}
